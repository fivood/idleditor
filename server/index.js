...
app.post('/api/generate-cover', async (req, res) => {
  ...
  if (!openai) {
    // Placeholder mode: return a gradient color based on prompt hash
...
app.listen(PORT, () => {
  console.log(`Cover API server running on http://localhost:${PORT}`)
  if (!openai) {
    console.log('No OPENAI_API_KEY set — using placeholder mode')
  }
})
