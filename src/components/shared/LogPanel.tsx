...
export function LogPanel() {
  ...
  if (toasts.length === 0) {
    return (
      <div className="bg-cream border-2 border-border-dark p-2 md:p-3 h-full flex flex-col shadow-[3px_3px_0_#4a3728]">
        <h3 className="text-[16px] md:text-xs font-bold text-ink mb-1 font-mono border-b-2 border-border-dark pb-1">出版日志</h3>
  ...
  return (
    <div className="bg-cream border-2 border-border-dark p-2 md:p-3 h-full flex flex-col shadow-[3px_3px_0_#4a3728]">
      <h3 className="text-[16px] md:text-xs font-bold text-ink mb-1 md:mb-2 shrink-0 font-mono border-b-2 border-border-dark pb-1">出版日志</h3>
