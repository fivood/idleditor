...
import { advanceCalendar, TICKS_PER_DAY } from '@/core/calendar'
import { checkDateEvent } from '@/core/dateEvents'
...
export function processCalendarPhase(world: GameWorldState, { ct }: TickContext, result: TickResult): PhaseResult {
