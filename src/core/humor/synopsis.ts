...
const CURATED_SYNOPSES: Record<string, string> = {
  ...
  '蝇王蜜蜂篇': '一群孩子因事故被困荒岛，分成两派。一派捡贝壳，一派砸椰子。权力的本质在童真中显露。直到一只蜜蜂飞过，所有人尖叫逃散。戈尔丁《蝇王》的甜美续篇。',
  ...
  '甲虫版变形计': '格里高尔醒来变成了一只甲虫。他的家人从关心到嫌弃用了大约六天。在这版里，格里高尔用爪子打字写了一本回忆录，寄给了出版社。卡夫卡太严肃了。这里加了吐槽。',
  '双语包法利夫人': '爱玛·包法利嫁给了一个无趣的乡村医生，然后开始读言情小说、和情人私奔、疯狂消费。出版社为这部经典添加了双语注释，其中编辑注占了一半篇幅，主要内容是"你为什么不离婚？？"',
  '平装盖茨比': '一个神秘的百万富翁每周开派对，希望能吸引对岸的旧情人。他有钱，有豪车，有没完没了的派对。但缺一本出版合同。菲茨杰拉德经典加入出版社视角。',
  '洛丽塔审查笔记': '一个文学教授爱上了一个少女，用华丽的语言描写这段关系。出版社编辑读完后沉默了十分钟，然后在稿纸上写了"文笔很好，但你还是去自首吧"。纳博科夫的经典，加上编辑批语。',
  '鲁滨逊隔离记': '一个人漂泊到荒岛，独自生活二十八年，救了一个野人取名星期一。他种麦子、养山羊、写日记，日记主要内容包括"今天还是没人说话"。笛福如果活在2020年应该会写这个版本。',
  '注音版尤利西斯': '一个广告推销员在都柏林游荡了一整天，脑子里想了十万件事。全本注音方便华人读者阅读，可惜注音比正文还多。乔伊斯如果知道自己的书被加了拼音，应该会觉得"很合理"。',
  '城堡物业管理指南': '一个土地测量员来到城堡，被告知需要办入住手续。他花了一整年找管事人签字，管事人退休了。新版加入物业管理的视角：原来城堡连电梯都没装。卡夫卡如果当过物业经理。',
  ...
  '百年孤独附家谱': '布恩迪亚家族七代人的故事，在一百年间经历了爱情、战争、香蕉公司、失眠症和连续下了四年的大雨。新版附赠家谱，因为你一定记不住那些名字，出版社也记不住，马尔克斯如果知道读者需要家谱才能读完，应该会微笑着点一根烟。',
  '接种霍乱时期的爱情': '一个男人等了一个女人五十一年九个月零四天。在此期间他和六百多个女人发生了关系。但他坚称自己是忠贞的。本书出版于霍乱时期结束，不是因为疫情结束，而是因为出版社终于收到了完稿。',
  '动物庄园财报': '农场的动物推翻了人类主人，建立了动物主义公社。七条戒律逐渐减少，猪开始用两条腿走路。在这版里，动物们最终在开会时使用了投票系统，猪在提案中说"所有动物都是平等的，但有些动物比另一些更有表决权"。',
  '白鲸极简版': '亚哈船长追逐一条白色巨鲸，而这条鲸鱼，在这版里，似乎并不想被追。它游过太平洋、印度洋，偶尔回头看后面那艘船是否还在。改编自麦尔维尔经典：500页的捕鲸百科被精减为80页的追逐戏。',
  '百年孤独超浓缩版': '原版《百年孤独》的浓缩加吐槽。布恩迪亚家族在一百年间生了十七个奥雷里亚诺。最后一场飓风把村子吹回第一页，等等，这难道不是莫比乌斯环？马尔克斯：我没说过这句，但可以有。',
  '傲慢与偏见与更偏见': '贝内特家有五个女儿要嫁出去。伊丽莎白·贝内特，最有脑子的那个，和达西先生从互相看不起到互相爱慕用了三百五十页。在这版里，编辑在旁注中频繁提出疑问：为什么他们都那么闲？为什么所有对话都发生在客厅？',
  '大厂骑士堂吉诃德': '一个五十岁的前大厂程序员读了太多网文，决定成为互联网时代的骑士。他把同事桑丘发展成创业伙伴，把风车当成竞品公司。一路上他们参加路演、被投资人拒绝、被收购，从幻想到幻灭，但代码从不说谎。塞万提斯的理想主义者走进硅谷。',
  '神的九十亿零一个名字': '西藏的喇嘛请人计算神的所有名字，九十九亿个名字。在原著里，计算完毕时星星开始熄灭。在这版里，发现少算了一个，编辑要求补上。智子立刻拒绝说"这不在合同里"。改编自克拉克经典短篇。',
  '海伯利安经济舱': '七名朝圣者前往海伯利安星球上的光阴冢。每个朝圣者都有各自的痛苦故事。在这版里，他们的旅程被压缩到了经济舱的座位上，膝盖顶着前排，但你还能听他们讲故事。',
  '冬星社交礼仪指南': '一个特使来到冬星，上面的人没有固定性别。他努力理解这个社会的规则，同时试图说服冬星加入星际联盟。在这版里，最大的障碍不是政治，是社交礼仪。改编自勒古恩经典：握手到底该用哪只手？',
  '格列佛短视频游记': '格列佛漂流到小人国、大人国、飞岛国和智马国。每段旅程都在抖音上被剪辑成十五秒的视频。最火的一条是他在小人国被绑住的片段，评论区说"这就是我在职场的日常"。斯威夫特如果活在今天，应该会开个账号。',
  '神曲弹幕游览': '但丁在人生中途迷失了方向，维吉尔带他游历地狱、炼狱和天堂。地狱有九层，惩罚对应罪行。在这版里，弹幕覆盖了大部分画面，"这层是什么罪？" "翻一下" "我要去天堂找贝雅特丽齐"。',
  '热血资本论': '卡尔·马克思花了十五年写《资本论》，分析了资本主义的生产方式和剩余价值。在这版里，他的理论被改编成漫画，对话框里充满了"使用价值"、"交换价值"和"我为什么付不起房租"。每个章节结束都有一张漫画插图：马克思在伦敦街头愤怒地计算面包的价格。',
  '打工狗的呼唤': '巴克是一只大狗，被人从温暖的加州偷走卖到阿拉斯加当雪橇犬。他在荒野中找回了祖先的狼性。在这版里，巴克被卖到了上海的共享单车公司，他的野性被换成了KPI。杰克·伦敦如果来过中国，应该会写这个版本。',
  '波伏娃退稿往事': '西蒙·波伏娃在1949年出版了《第二性》，一部关于女性处境的地毯式调查。在这版里，她的出版商一开始拒绝了稿件，理由是"这个话题太超前"。波伏娃回信说"你们会在七十三年后后悔"，然后找了另一家出版社。',
  '彻底失眠的马洛': '硬汉侦探菲利普·马洛被卷入一桩勒索案。案件牵扯到一个年迈的将军和他两个麻烦的女儿。在这版里，马洛发现案件没有一天能让他正常睡觉，不是在凌晨三点接到电话，就是在凌晨五点被人跟踪。改编自钱德勒经典，标题都是认真的。',
  '包邮马耳他之鹰': '一只黑鸟雕像，几个贪婪的人，侦探山姆·斯佩德周旋其中。雕像据说是无价之宝。在这版里，斯佩德在亚马逊上搜了一下，发现同款只要19.99美元。哈米特的硬汉经典加入消费者视角。',
  '消失的爱人朋友圈直播': '结婚五周年那天，艾米的丈夫报了她的失踪。但艾米不是被害者，她设计了一整套计划来陷害他。在这版里，整个事件都在社交媒体上同步直播，艾米的微博每天更新日记，网友分为两派激烈争吵。吉莉安·弗林如果活在中国互联网时代。',
  '远望酒店报修单': '杰克·托伦斯一家搬到远望酒店当冬季看管员。酒店里没有客人，但有鬼魂，还有一个需要不断报修的锅炉。在这版里，杰克的疯狂是逐渐累积的：先是水管爆了，然后是电梯停了，最后是那台打印机卡住了第三百次。斯蒂芬·金如果写过物业投诉。',
  '肖申克转型案例': '银行家安迪被冤枉入狱，在肖申克监狱度过了二十年。他帮狱警做税务、帮典狱长洗钱、用一把小锤子挖了十九年的地道。在这版里，他的逃狱计划被做成了一份PPT，标题是"从囚犯到自由人：一个转型案例"。',
  '达芬奇密码重置提醒': '卢浮宫馆长被谋杀，留下了一系列密码线索。罗伯特·兰登被卷入一场涉及圣杯、隐修会和天主教会秘密的斗争。在这版里，所有的密码都因为密码强度策略而必须在90天内重置一次。丹·布朗的悬疑加上IT部门的日常。',
  '弗兰肯斯坦面试记': '维克多·弗兰肯斯坦用尸块拼出了一个有知觉的生物，然后立刻恐惧地逃离了。生物在孤独中寻求理解。但他被拒绝了，因为他没有通过公司的行为面试。玛丽·雪莱的经典，HR部门表示"他非常有创造力，但缺乏团队合作经验"。',
  '寂静的市区春天': '蕾切尔·卡森在1962年警告世界：杀虫剂正在毁灭生态。在这版里，她警告的是市区的噪音污染和光污染，"如果鸟类不来了，那人类也快了，只不过我们还没意识到"。原创。但卡森会认同的。',
  '雪崩元宇宙版': '在未来的美国，自由市场触及一切，连政府都变成了连锁加盟。主角弘·主角是披萨快递员，兼职黑客。在这版里，他引入了一种叫"雪崩"的病毒。它同时感染人脑和电脑，而且，基于区块链技术。尼尔·斯蒂芬森的赛博朋克经典加了Web3滤镜。',
  '与罗摩的线上会议': '人类发现一颗圆柱形外星飞船飞入太阳系。宇航员进入其中探索，发现了一个沉默的人造世界。在这版里，所有的探索都是通过远程视频完成的，因为AI风险评估说"实体进入风险太高"。阿瑟·克拉克如果提前看到了Zoom时代。',
  '火星定居公众号': '人类殖民火星的一系列短篇故事。火星人濒临灭绝，殖民者把地球的一切带到了新世界。在这版里，每个故事都被编译成微信推文，标题都是"火星定居第三天，我发现了土著留下的惊天秘密"。雷·布拉德伯里的诗意科幻被算法分发。',
  '咖啡因大眠': '硬汉侦探马洛被卷入一桩勒索案。在这版里，他一直在喝咖啡，不是因为他需要清醒，而是因为这个世界需要清醒的人。钱德勒如果改喝咖啡。',
  '微信里漫长的告别': '马洛帮助一个醉汉逃到墨西哥，然后发现他被指控谋杀了妻子。在这版里，所有的告别都是通过微信消息，我走了，然后对方再也没有回复。钱德勒的硬汉文学被现代通讯稀释。',
  '纹身贴女孩': '记者布隆维斯特和黑客萨兰德调查一桩四十年悬案。在这版里，萨兰德用一次性纹身贴，每天换一个图案。问她为什么，她说懒得选。拉尔森的北欧悬疑变得懒散了一点。',
  '曼陀丽庄园改稿记': '无名女主角嫁给丧偶贵族马克西姆，搬进曼陀丽庄园，被前任丽贝卡的影子纠缠。在这版里，丽贝卡生前是一个要求改稿二十次的作者。杜穆里埃的经典加入出版行业视角。',
  '风之影下架风波': '达涅尔在巴塞罗那的遗忘书之墓发现了一本书，寻找作者其他作品时发现有人正一本本销毁它们。在这版里，书不是被烧毁，是被下架。亚马逊的算法判定作者销量太低。萨丰的文学悬疑被数字时代重新语境化。',
  '修道院物管疑云': '修士威廉来到修道院调查死亡，图书馆藏着涂了毒药的《诗学》第二卷。在这版里，威廉发现真凶是物业管理公司，为了涨租金下毒然后栽赃给书。埃科如果当过业委会主任。',
  '鬼店连锁加盟计划': '杰克·托伦斯带家人来远望酒店当冬季看管，幽灵把他慢慢逼疯。在这版里，远望酒店是连锁加盟店，杰克是加盟商。幽灵们开了董事会讨论淡季入住率。斯蒂芬·金走进资本市场。',
  '996美丽新世界': '未来社会人类在试管中出生，基因决定等级。快乐是一种叫唆麻的药物。在这版里，唆麻被996代替，人们不是因为快乐而不反抗，是因为太累了。赫胥黎如果在大厂工作过。',
  '散装云图': '六个嵌套故事跨越数百年。在这版里，出版社把六个故事打散了重新装订，每个读者读到的顺序都不一样。大卫·米切尔遇到散架的印刷厂。',
  '少年派脱口秀访谈': '印度男孩和孟加拉虎在太平洋上漂流两百多天。在这版里，主角最后参加了奥普拉脱口秀，观众对老虎那段最感兴趣。扬·马特尔看到了播客时代的尽头。',
  '正午之子': '萨利姆在印度独立那一刻出生，拥有心灵感应。在这版里，他出生在正午，能力不是心灵感应，而是准时，在任何会议中都准时出席。鲁西迪看到印度IT外包产业的崛起。',
  '安德的离职影子': '在战斗学院，安德的哥哥彼得在地球策划政治夺权。在这版里，彼得阴谋被转化成竞业禁止协议。安德学会了开出版社。奥森·斯科特·卡德如果当过HR。',
  '基地物业管理公司': '谢顿创造心理史学，预言银河帝国崩溃，建立基地保存人类知识。在这版里，基地是一家物业管理公司，维护帝国崩坏后的最后几栋建筑。阿西莫夫看过业主委员会会议。',
  ...
  '时光之轮漫长铺垫': '真龙转世兰德·亚瑟发现自己注定要对抗暗帝。但首先，他需要和另外五个同村青年分头旅行。每个人都在自己的故事线里铺垫了一整卷。据说最后一战会很精彩，等铺垫完第十五卷就知道。致敬罗伯特·乔丹《时光之轮》。',
  ...
  '魔戒销毁精装指南': '弗罗多得到一枚魔戒，必须在末日火山的岩浆里销毁它。这本指南详细介绍了三个备选方案：毁掉、归还、或者放保险箱里假装没找到。甘道夫写了序言，阿拉贡负责配送路线图。托尔金的史诗插入出版流程。',
  ...
  '王者之路断更篇': '卡拉丁被卖为奴隶，在破碎平原上搬运桥梁。故事在第一卷结束时进入了高潮。但那只是整个系列十卷中的第一卷。读者等了多年，作者承诺"快了"。飓光志系列的缩影。',
  '飓风笔记又在下雨': '柔刹大陆上每几天就有一场超级飓风。卡拉丁想当军人，沙兰想偷东西，达力拿在做梦。所有人都在下雨中奔跑。第一卷末尾雨停了，第二卷马上又要下。桑德森的史诗气质被天气报告概括。',
  '猎稿人：最后的退稿信': '利维亚的杰洛特是猎魔人，靠杀怪物讨生活。但在这一版，他转型为出版社的退稿专员，用银剑砍掉不好的稿子。每个退掉的作者都会说"但我的稿子是特别的"。杰洛特默默喝下魔药，继续审稿。致敬萨普科夫斯基《猎魔人》。',
  '命运之剑交稿前夜': '希里注定是时空的女儿，但此刻她只是窝在编辑部的沙发上赶稿。叶妮芙用魔法催稿，杰洛特在门外踱步，他不是来催稿的，他是来保护他的命运之子不被退稿信击垮。',
  ...
  '风之名失传续集': '科沃斯在旅店向记录者讲述自己的传奇，一个天才音乐家、魔法师、剑客的成长故事。他在第一天讲完了第一卷的内容。第二天开始了第二卷。第三天，记录者睡着了。帕特里克·罗斯弗斯的未完结传奇，读者们在等。',
  '写不完的智者之惧': '科沃斯继续讲述他的故事。他在学院里学习了更多魔法，在费尔伦森林里遇到了费露瑞安。但讲述者越来越不安，他意识到自己的故事太长，而作者可能永远写不完第三卷。',
  '地海版权拉扯史': '格得从牧童成长为地海的大法师。他释放了黑暗，又收回了名字。这个版本里，版权被卖给了十二家不同的出版社，每家都出了一套封面完全不同的版本。勒古恩的经典被出版业拉扯。',
  '纳尼亚空衣柜之谜': '露西走进衣柜，发现了纳尼亚。狮子阿斯兰创造了世界，白女巫让世界永远冬天。这版更关注衣柜本身，为什么里面只有皮毛没有衣架？彼得说这是魔法衣柜，苏珊说这违反了英国消防规定。',
  '迷雾散去的巨坑': '纹在终焉之世学会了燃烧金属获取魔法力量。她和凯尔西耶计划推翻统治帝国千年的神皇。雾散了，帝国崩溃了。但桑德森说这只是三部曲的第一部。后面还有四个时代和不知道多少本外传。',
  '第一律法附加条款': '洛根·九指想摆脱暴力，却总被卷入战争。法官格罗塔拷问囚犯的方式是让他们读合同。联盟国的第一律法只有一条。但附加条款从第二条写到了第四百条。阿伯克龙比如果当过律师。',
  '黑暗塔楼梯拉练': '枪侠罗兰追踪黑衣人穿越一片辽阔的荒原，寻找黑暗塔，多重宇宙的中心。在这一卷里，罗兰发现塔的电梯坏了，必须爬三千层楼梯。金爷的史诗进入物业维修周期。',
  '时光之轮马拉松版': '兰德·亚瑟是转生的龙，但更令人惊讶的是。这套书有十四卷。每一卷都以一场大战结束，然后下一卷开始铺垫更大的一场大战。如果你从第一卷开始，读完时你的孙子可能已经出生。致敬罗伯特·乔丹。',
  '年更龙枪编年史': '一群英雄在克莱恩大陆寻找龙枪，对抗黑暗之后塔克西丝。他们经历了春、秋、冬。但夏天被跳过了，因为作者说"夏天不适合冒险"。每本都是年度畅销。但部分粉丝觉得兔子人坎德人太能偷东西。',
  '被作者遗忘的国度': '费伦大陆上有深水城、博德之门、无冬城，每个城市都有各自的英雄。但这些英雄彼此没见过面，因为他们被不同的作者编在不同的书里。连创世神AO也忘记了某些角落还在连载的故事。D&D官方世界观的自嘲。',
  '东方慢车谋杀案': '波洛侦探在一辆被大雪困住的列车上调查一桩谋杀案。在这版里，所有人都有嫌疑，所有人都有动机。但由于列车晚点太严重，凶手在警方赶到前就已经因为没有餐车供应而饿死了。阿加莎的经典遇到了现代铁路局。',
  '无人生还团建日': '十个互相不认识的人被邀请到一座孤岛上。在这版里，这其实是公司强行组织的周末团队建设。为了逃避无聊的破冰游戏和PPT汇报，他们决定假装一个接一个地死掉。阿加莎的悬疑故事变成了社畜的逃生指南。',
  '福尔摩斯咨询账单': '贝克街的侦探只要看一眼你的袖口就能知道你的身世。在这版里，华生把这些故事全整理成了咨询报告。每次福尔摩斯刚要开始推理，华生就会打断他并递给客户一份账单。毕竟在伦敦租房子实在太贵了。',
  '银河系报销指南': '地球被炸毁了，只为了给一条超空间快速通道让路。阿瑟·邓特穿着睡衣开始了星际漫游。在这版里，他最关心的问题不是宇宙的终极答案，而是这些跨星系的旅行费用到底能不能回公司报销。道格拉斯·亚当斯的荒诞加上了财务部的冷酷。',
  '时间机器加班循环': '时间旅行者去到了公元八十万年，发现了埃洛伊人和莫洛克人两个极端进化的种族。在这版里，他发现时间机器的唯一用途是回到周一早上，让自己有更多的时间把周五没交的稿子写完。威尔斯的科幻经典变成了时间循环噩梦。',
  '鹦鹉螺号年检记': '尼莫船长驾驶着鹦鹉螺号在海底漫游，寻找自由和避难所。在这版里，他最头疼的不是大王乌贼，而是这艘核动力潜水艇又到了每年一次的强制年检时间。儒勒·凡尔纳的科幻巨著里充满了环保局的警告信。',
  '悲惨房贷世界': '冉阿让因为偷了一块面包被判了十九年苦役。出狱后他改头换面，成了一名市长。在这版里，沙威警长对他穷追不舍，纯粹是因为冉阿让还欠着银行三十年的房贷没还清。雨果的浪漫主义遭遇了现代金融体系。',
  '麦田里的实习生': '霍尔顿被学校开除后在纽约街头游荡，觉得周围所有人都是假模假式的。在这版里，他刚好来到永夜出版社当了三天实习生。面对堆积如山的烂稿子，他终于明白为什么大人都那么虚伪。因为不虚伪就只能写直白的退稿信了。',
  '催更似水年华': '马塞尔咬了一口玛德琳蛋糕，随之涌现了长达七卷的庞大童年回忆。在这版里，编辑每隔五分钟就打电话问他吃完蛋糕没有。普鲁斯特慢条斯理地表示，回忆才刚进行到第三个星期，请耐心等待。这绝对是出版界最漫长的等待。',
  '仿生人绩效考核': '里克·德卡德的工作是追捕逃跑的仿生人。在这版里，他发现最难区分人类和机器的方法，是看他们会不会在工作时间做白日梦。如果有，那肯定是人类。菲利普·迪克的赛博朋克变成了残酷的绩效考核。',
  '克苏鲁精神损失费': '调查员在旧报纸和古怪雕像中发现了沉睡在海底的邪神。看一眼就会陷入疯狂。在这版里，调查员看完后依然坚持把报告写完。因为如果不交报告，下个月的工资和精神损失费就没着落了。洛夫克拉夫特的不可名状遇到了劳动法。',
  '呼啸山庄产权案': '希斯克利夫和凯瑟琳之间有着毁灭性的爱情。他回来只为了对所有欺负过他的人进行报复。在这版里，他的复仇手段非常现代。他聘请了顶级律师，硬是通过复杂的产权纠纷把所有人的房子都合法收走了。哥特式浪漫加入了法务视角。',
  '六便士辞职信': '斯特里克兰突然抛弃了优渥的生活，跑去塔希提岛画画。在这版里，他没有留下只言片语，只是在办公桌上留了一张画着六便士的辞职信。HR部门为了给他办离职手续，足足找了他三年。毛姆的艺术理想主义被职场流程死死卡住。',
  '基督山投资踩坑记': '唐泰斯在伊夫堡监狱关了十四年，找到宝藏后化身基督山伯爵回来复仇。在这版里，他把巨额财宝交给了一个投资顾问。等他准备好华丽的复仇计划时，发现钱早就被顾问亏光了。大仲马的爽文直接遭遇了金融危机。',
  '双城跨国通勤': '那是最好的时代，也是最坏的时代。伦敦和巴黎在革命的阴影下双城联动。在这版里，主角最痛苦的不是上断头台。而是每周五晚上都要在两座城市之间忍受长达十小时的跨国列车通勤。狄更斯的历史小说充满了对公共交通的怨念。',
  '安娜晚点记': '安娜在虚伪的上流社会中绝望地寻找真爱，最终选择在火车站结束生命。在这版里，她站在站台上等了六个小时。火车因为天气大面积晚点。最后她实在冻得受不了，只能打车回家。托尔斯泰的悲剧被糟糕的铁路系统挽救了。',
  '拖延症王子哈姆雷特': '丹麦王子哈姆雷特为了给父亲报仇，装疯卖傻。生存还是毁灭，这是一个问题。在这版里，他其实只是个重度拖延症患者。他把复仇计划列在代办清单上，但每天都在玩手机。莎士比亚的悲剧完美解释了拖稿作者的心理活动。',
  '卡拉马佐夫避税指南': '老卡拉马佐夫被谋杀，三个兄弟卷入了关于信仰和道德的痛苦审判。在这版里，他们根本没空讨论上帝是否存在。他们所有的时间都花在了和税务局争论怎么才能少交一点遗产税上。陀思妥耶夫斯基输给了会计师。',
}
