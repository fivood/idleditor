...
export const HYBRID_TITLES = [
  ...
  '时光之轮 · 第十四卷还在铺垫', '冰与火之鸽', '凛冬的截稿日',
  '铁王座的排队叫号系统', '权力的游戏 · 卡在第六卷',
  '魔戒：销毁指南 · 精装插图版', '霍比特人的下午茶食谱',
  '精灵宝钻 · 翻译组已解散', '中土世界物业管理办法',
  '王者之路 · 但作者还没写完', '飓风笔记：卷一 · 又在下雨',
  '猎稿人：最后的退稿信', '命运的剑 · 交稿前夜',
  '碟形世界地质学纲要', '死神学徒的编辑实习期',
  '风之名 · 已失传续集', '智者之惧 · 作者之惧写不完',
  '地海传说 · 版权已售出十二次', '纳尼亚传奇 · 衣柜里没有衣架',
  '迷雾之子 · 雾散了故事还没完', '第一律法 · 第四百条附加条款',
  '黑暗塔 · 电梯维修中请走楼梯', '时光之轮 · 又长又绕版',
  '龙枪编年史 · 年更版', '被遗忘的国度 · 作者也忘了',
]
