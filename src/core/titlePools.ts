...
export const HYBRID_TITLES = [
  ...
  '散装云图', '少年派脱口秀访谈', '正午之子',
  '白鲸极简版',
  '鬼店连锁加盟计划', '远望酒店报修单', '肖申克转型案例',
  '修道院物管疑云', '风之影下架风波', '达芬奇密码重置提醒',
  '百年孤独超浓缩版', '接种霍乱时期的爱情',
  '寂静的市区春天', '弗兰肯斯坦面试记',
  // Fantasy epic parodies
  '时光之轮漫长铺垫', '冰与火之鸽', '凛冬的截稿日',
  '铁王座的排队叫号系统', '权力的游戏 · 卡在第六卷',
  '魔戒销毁精装指南', '霍比特人的下午茶食谱',
  '精灵宝钻 · 翻译组已解散', '中土世界物业管理办法',
  '王者之路断更篇', '飓风笔记又在下雨',
  '猎稿人：最后的退稿信', '命运之剑交稿前夜',
  '碟形世界地质学纲要', '死神学徒的编辑实习期',
  '风之名失传续集', '写不完的智者之惧',
  '地海版权拉扯史', '纳尼亚空衣柜之谜',
  '迷雾散去的巨坑', '第一律法附加条款',
  '黑暗塔楼梯拉练', '时光之轮马拉松版',
